...
customEvents = {
    TeamPerk = function(data)
        ...
        if (not GameHasFlagRun("NT_GAMEMODE_CO_OP") or not GameHasFlagRun("team_perks")) then return nil end
...
wsEvents = {
    ...
    RequestGameInfo = function(data)
        ...
        SendWsEvent({event="GameInfo", payload={seed=seed, mods=mods, version="v0.9.55", beta=GameIsBetaBuild()}})
